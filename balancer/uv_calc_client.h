...
typedef void (*dc_balancer_cc_proc_cb_t)(uv_stream_t* req_client, char* req_str, char* result_str);
typedef void (*dc_balancer_cc_error_cb_t)(uv_stream_t* req_client, char* req_str);
...
typedef struct calc_client_descr_t {
	...
	dc_balancer_cc_proc_cb_t on_result_fn;
	dc_balancer_cc_error_cb_t on_err_fn;
